...
- **Watch em-dash density.** Em-dashes are useful for interruptions and parenthetical asides, but they lose punch when overused. Limit to one per paragraph. When you find yourself reaching for a second, use a period, comma, colon, or parentheses instead.
